...
A soundboard page is a quick way to audition your banks and tune volumes/pitches without running the full game.
...
### `index.html` (single-file soundboard)
...
When you’re happy, copy the tuned values back into the bank definitions.
